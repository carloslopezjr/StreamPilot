...
def gen_desc(prompt):
    ...
    response = client.chat.completions.create(
        ...
        messages=[
            ...
            {"role": "user", "content": "Make sure all of the responses start with the following format Response: and dont add quotations at the start and end of the response"}
        ],
        max_tokens=1000
    )
